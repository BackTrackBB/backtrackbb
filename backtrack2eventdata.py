...
basepath_data = '/mnt/data/Tremor_Shikoku/Tremor_data/120531/19/'
out_data_format = "SAC"
...
if station_file:
    for line in open(station_file,'r'):
        ...
        coord_sta[data[0]] = (float(data[2]),float(data[3]),float(data[4]))
...
##---creating output directories if do not exist--------------------------------------------------
